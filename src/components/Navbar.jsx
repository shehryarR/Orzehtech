    ...
    { 
      ...
      items: [
        ...
        { 
          ...
          icon: <img src={digitalIcon} alt="Digital" className="w-full h-full object-contain grayscale brightness-0 opacity-40 transition-opacity duration-200 group-hover:opacity-60" />
        },
        { 
          href: '#/voice-ai', 
          label: 'Voice AI',
        ...
        { 
          href: '#/ai-automation', 
          label: 'AI Automation',
          icon: <img src={aiAutomationIcon} alt="Automation" className="w-full h-full object-contain grayscale brightness-0 opacity-40 transition-opacity duration-200 group-hover:opacity-60" />
        },
        { 
